...
namespace DXApplication3.Main
{
    ...
    public class Bootstrapper
    {
        ...
        protected virtual void RegisterModules()
        {
            ...
            Manager.Register(Regions.Documents, new Module(AppModules.Module1, () => ModuleViewModel.Create("Module1", "Module1 Content", new NavigationService()), typeof(ModuleView)));
            Manager.Register(Regions.Documents, new Module(AppModules.Module2, () => ModuleViewModel.Create("Module2", "Module2 Content", new NavigationService()), typeof(ModuleView)));
        }
